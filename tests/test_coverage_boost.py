...
def test_base_validator_structures():
    ...
    from kindlemint.validators.base_validator import (
        IssueSeverity, ValidationIssue, ValidationReport
    )
...
def test_message_protocol_enums():
    ...
    from kindlemint.agents.message_protocol import MessageType, MessagePriority
...
def test_utils_module_coverage():
    ...
    from kindlemint.utils import config, ConfigLoader
