...
class TestSetupPyDependencies:
    ...
    def test_install_requires_format(self):
        ...
        security_deps = [line for line in install_requires_lines if 'security' in line]
    ...
    def test_dependency_alphabetical_order(self):
        ...
        assert dependencies == sorted_dependencies, f"Dependencies not in alphabetical order. Expected: {sorted_dependencies}, Got: {dependencies}"
