...
class TestVoiceToBookPipeline:
    ...
    async def test_process_voice_file(self, pipeline):
        pipeline.voice_processor.extract_intent.return_value = {"expertise": ["tech"], "tone": "formal", "audience": "developers", "goals": ["educate"]}
        ...
        assert result["intent"] == {"expertise": ["tech"], "tone": "formal", "audience": "developers", "goals": ["educate"]}
    ...
    async def test_build_author_context(self, pipeline):
        ...
        intent = {"expertise": ["AI"], "tone": "informal", "audience": "general", "goals": ["inform"]}
    ...
    async def test_generate_chapters(self, pipeline):
        voice_data = {
            "book_content": "Section 1. Section 2. Section 3."
        }
        pipeline.content_generator.split_into_sections.return_value = [
