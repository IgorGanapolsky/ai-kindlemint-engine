...
class TestFreeMarketResearch:
    ...
    def test_analyze_amazon_competition(self):
        ...
        required_keys = ["search_volume", "competition_score", "average_price", "average_rating", "total_results"]
        for key in required_keys:
            assert key in result
            assert isinstance(result[key], (int, float))
        
        # Test with unknown keyword
        result_unknown = self.market_research.analyze_amazon_competition("unknown_keyword_12345")
    ...
    def test_get_free_keyword_suggestions(self):
        ...
        suggestions = self.market_research.get_free_keyword_suggestions("sudoku")
...
class TestFreeKDPAutomationEngine:
    ...
    def test_calculate_opportunity_valid_data(self):
        ...
        opportunity = self.engine._calculate_opportunity("test_keyword", amazon_data)
