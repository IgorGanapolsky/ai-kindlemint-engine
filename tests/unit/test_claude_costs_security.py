...
class TestClaudeCostsSecurity(unittest.TestCase):
    ...
    def test_badge_command_with_safe_command(self, mock_safe_command, mock_tracker_class):
        ...
        self.assertTrue(str(command_args[1]).endswith("generate_cost_badges.py"))
    ...
    @patch('scripts.claude_costs.safe_command')
    @patch('sys.argv', ['claude_costs.py', 'badge'])
    def test_badge_command_handles_safe_command_error(self, mock_safe_command, mock_tracker_class):
    ...
    def test_safe_command_import_available(self, mock_safe_command, mock_tracker_class):
        ...
        try:
            from scripts import claude_costs
            from security import safe_command  # This should not raise ImportError in test
    ...
    @patch('scripts.claude_costs.safe_command')
    @patch('sys.argv', ['claude_costs.py', 'badge'])
    def test_badge_script_path_resolution(self, mock_safe_command, mock_tracker_class, mock_path):
