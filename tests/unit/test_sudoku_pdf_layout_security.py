...
class TestSudokuPDFLayoutSecurity(unittest.TestCase):
    ...
    def test_no_random_import_in_get_puzzle_insight(self):
        ...
        source = inspect.getsource(layout_module.EnhancedSudokuPDFLayout.get_puzzle_insight)
    ...
    def test_random_module_not_imported_at_top_level(self):
        ...
        script_path = Path(__file__).parent.parent.parent / "scripts" / "sudoku_pdf_layout_v2.py"
