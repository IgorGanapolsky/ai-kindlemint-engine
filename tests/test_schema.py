...
class TestMarketResearchSchema:
    ...
    def test_summary_json_exists(self):
        ...
        assert 'top_opportunities' in summary, "Summary missing 'top_opportunities' field"
        assert isinstance(summary['top_opportunities'], list), "top_opportunities must be a list"
    ...
    def test_data_quality(self):
        ...
        assert max(sales_range) <= 100000, "Sales estimates seem unrealistic (>100k/month)"
