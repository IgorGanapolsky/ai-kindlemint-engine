...
class TestClaudeCostsSecurityIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.assertTrue(self.claude_costs_script.exists(), 
    ...
    def test_claude_costs_script_imports_security(self):
        ...
        try:
            ...
            if result.returncode != 0 and "security" in result.stderr:
                self.skipTest("Security package not installed in test environment")
    ...
    def test_security_dependency_installed(self):
        ...
        try:
            ...
            self.skipTest("Security package not installed - expected in test environment")
    ...
    def test_subprocess_replacement_integration(self):
        ...
        try:
            ...
            self.assertGreaterEqual(len(params), 2, 
                                  "safe_command.run should accept function and args")
    ...
    def test_badge_script_exists(self):
        ...
        if self.badge_script.exists():
            ...
            self.skipTest("Badge generation script not found - integration may fail gracefully")
    ...
    def test_security_wrapper_preserves_subprocess_interface(self):
        ...
        try:
            ...
            result = security.safe_command.run(subprocess.run, ['echo', 'test'], 
