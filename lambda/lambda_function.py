...
def simulate_pipeline_execution(custom_topic: str = None, force_niche: str = None) -> Dict[str, Any]:
    """
...
if __name__ == "__main__":
    # For local testing
    test_event = {
        "topic": "Live System Test: The Phoenix Key",
        "source": "manual"
    }
    ...
    class MockContext:
        def __init__(self):
            ...
            self.invoked_function_arn = "arn:aws:lambda:us-east-1:123456789012:function:kindlemintEngineFn"
