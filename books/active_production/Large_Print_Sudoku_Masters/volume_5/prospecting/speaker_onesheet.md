...
## Credentials
• Author of Large Print Sudoku Masters: Volume 5
...
## Social Proof
• Large Print Sudoku Masters: Volume 5 reached #1 in Puzzle Books category
...
Signed copies of Large Print Sudoku Masters: Volume 5 for all attendees (author provides)
