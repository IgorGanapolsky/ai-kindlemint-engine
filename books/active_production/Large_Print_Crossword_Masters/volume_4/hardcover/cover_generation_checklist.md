...
- **Spine Width**: 0.45 inches (calculated)
...
Full cover dimensions: 12.7" wide × 9.25" tall (includes 0.125" bleed on all edges)
Spine width: 0.45" (centered in the design)
Book format: 6 x 9 inches hardcover

Design requirements:
- Back cover (left side): Book description area, barcode space (2" × 1.2")
- Spine (center, 0.45" wide): Title and volume number readable when shelved
...
- [ ] Full cover dimensions: 12.7" x 9.25" (includes bleed)
