...
class AgentStatusHandler(BaseHTTPRequestHandler):
    ...
    def serve_health(self):
        ...
        health = {
            ...
            "uptime": getattr(self.status_monitor, 'uptime', 0) if self.status_monitor else 0
        }
    ...
    def serve_api_info(self):
        ...
        api_info = {
            ...
            "badge_types": [
                "system_status", "active_agents", "memory", 
                "task_queue", "health", "last_updated"
            ],
            "timestamp": datetime.now().isoformat()
        }
...
class AgentStatusServer:
    ...
    def start(self):
        ...
        def update_uptime():
            while True:
                if self.status_monitor:
                    self.status_monitor.uptime = (datetime.now() - self.start_time).total_seconds()
                time.sleep(1)
