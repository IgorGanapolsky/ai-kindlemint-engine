...
class CrosswordClueGenerator:
    def __init__(self):
        ...
        self.clue_database = {
            # 3-letter words
            "ACE": ["Playing card", "Tennis serve winner", "Expert pilot", "Top-notch", "Perfect serve"],
            "ADD": ["Sum up", "Plus operation", "Combine numbers", "Tally", "Include in total"],
            "AGE": ["Years lived", "Era", "Time period", "Get older", "Historical period"],
            "AID": ["Help", "Assistance", "First ___", "Support", "Relief"],
            "AIM": ["Target", "Goal", "Point at", "Objective", "Purpose"],
            "AIR": ["Breathable gas", "Atmosphere", "Broadcast medium", "Melody", "Ventilate"],
            "ALL": ["Everything", "Entire amount", "The whole thing", "100 percent", "Complete"],
            "AND": ["Plus", "Also", "Conjunction", "In addition to", "With"],
            "ANT": ["Picnic pest", "Colony insect", "Small worker", "Hill dweller", "Industrious bug"],
            "ANY": ["Whatever amount", "Some", "At all", "One or more", "Whichever"],
            "APE": ["Primate", "Gorilla cousin", "Mimic", "Copy", "Large primate"],
            "ARC": ["Curve", "Rainbow shape", "Part of circle", "Electrical spark", "Story progression"],
            "ARE": ["Exist (plural)", "You ___ here", "Square measure", "Metric unit", "To be"],
            "ARM": ["Limb", "Branch", "Weapon", "Supply with weapons", "Upper limb"],
            "ART": ["Creative work", "Gallery display", "Skill", "Paintings", "Museum piece"],
            ...
            "BAT": ["Baseball stick", "Flying mammal", "Cricket club", "Vampire form", "Swing at"],
            "BED": ["Sleep furniture", "Garden plot", "River bottom", "Place to rest", "Foundation"],
            "BEE": ["Honey maker", "Spelling contest", "Buzzing insect", "Busy worker", "Pollinator"],
            "BIG": ["Large", "Important", "Grown up", "Huge", "Major"],
            "BIT": ["Small piece", "Computer unit", "Horse restraint", "Slightly", "Fragment"],
            "BOW": ["Ribbon shape", "Violin stick", "Bend forward", "Arrow launcher", "Ship front"],
            "BOX": ["Container", "Fight", "Square", "Package", "Ring sport"],
            "BOY": ["Young male", "Lad", "Son", "Youth", "Male child"],
            "BUS": ["Public transport", "School vehicle", "Motor coach", "City transport", "Clear tables"],
            ...
            "DEW": ["Morning moisture", "Grass drops", "Dawn wetness", "Condensation", "Mountain ___ soda"],
            "DID": ["Performed", "Accomplished", "Past of do", "Executed", "Carried out"],
            "DIE": ["Expire", "Gaming cube", "Perish", "Cease living", "Singular of dice"],
            "DIG": ["Excavate", "Understand", "Archaeological work", "Shovel work", "Like"],
            "DOC": ["Physician", "Document", "Medical pro", "Seven dwarfs member", "PhD"],
            ...
            "EAR": ["Hearing organ", "Corn unit", "Sound sensor", "Lobe location", "Audio receiver"],
            "EAT": ["Consume", "Dine", "Have a meal", "Chow down", "Devour"],
            "EGG": ["Oval food", "Breakfast item", "Encourage", "Chicken product", "Easter decoration"],
            "ELF": ["Santa helper", "Pixie", "Small being", "North Pole worker", "Fairy tale creature"],
            ...
            "EYE": ["Vision organ", "Look at", "Storm center", "Needle hole", "Observe"],
            "FAN": ["Admirer", "Cooling device", "Enthusiast", "Spread out", "Sports supporter"],
            "FAR": ["Distant", "Remote", "Long way", "Not near", "Way off"],
            "FAT": ["Obese", "Grease", "Plump", "Cooking oil", "Not thin"],
            "FAX": ["Document transmitter", "Send electronically", "Office machine", "Quick message", "Pre-email communication"],
            "FEE": ["Charge", "Cost", "Payment", "Price", "Professional charge"],
            "FEW": ["Not many", "Some", "Small number", "Several", "Handful"],
            "FIG": ["Fruit", "Newton filling", "Tree fruit", "Dried fruit", "Mediterranean fruit"],
            ...
            "FOR": ["In favor of", "Because", "Purpose", "During", "Meant to be given to"],
            "FOX": ["Sly animal", "News channel", "Cunning one", "Red animal", "Chicken thief"],
            ...
            "GEL": ["Hair product", "Solidify", "Jelly", "Come together", "Styling aid"],
            "GEM": ["Jewel", "Precious stone", "Diamond", "Treasure", "Outstanding person"],
            "GET": ["Obtain", "Receive", "Acquire", "Understand", "Fetch"],
            "GOD": ["Deity", "Supreme being", "Creator", "Divine one", "Object of worship"],
            "GOT": ["Obtained", "Received", "Understood", "Past of get", "Acquired"],
            "GUM": ["Chewing substance", "Tree sap", "Adhesive", "Pink mouth part", "Sticky stuff"],
            "GUN": ["Weapon", "Firearm", "Pistol", "Accelerate", "Rifle"],
            "GUT": ["Stomach", "Intestine", "Instinct", "Inner feeling", "Remove insides"],
            "GUY": ["Fellow", "Man", "Dude", "Cable", "November 5 effigy"],
            "GYM": ["Exercise place", "PE class", "Workout spot", "School auditorium", "Fitness center"],
            ...
            "HAT": ["Head covering", "Cap", "Fedora", "Millinery item", "Bowler or beret"],
            "HAY": ["Dried grass", "Horse food", "Barn stack", "Make ___ while...", "Fever cause"],
            "HER": ["That woman", "Belonging to she", "Female pronoun", "Not him", "She, objectively"],
            "HEW": ["Chop", "Cut with axe", "Shape by cutting", "Carve", "Hack"],
            "HEX": ["Curse", "Six-sided", "Spell", "Bewitch", "Evil spell"],
            "HID": ["Concealed", "Past of hide", "Kept secret", "Stashed", "Put out of sight"],
            "HIM": ["That man", "Male pronoun", "Not her", "He, objectively", "That guy"],
            "HIP": ["Body joint", "Cool", "Trendy", "Rose fruit", "Pelvis part"],
            "HIS": ["Belonging to him", "That man's", "Male possessive", "Not hers", "Of him"],
            "HIT": ["Strike", "Success", "Punch", "Popular song", "Baseball achievement"],
            ...
            "HOW": ["In what way", "Question word", "Method inquiry", "By what means", "___ come?"],
            "HUB": ["Center", "Airport", "Wheel center", "Main location", "Activity center"],
            ...
            "INK": ["Pen fluid", "Tattoo material", "Squid defense", "Writing fluid", "Press material"],
            "INN": ["Small hotel", "Tavern", "Lodge", "Roadside stop", "B&B"],
            "ION": ["Charged particle", "Atom type", "Saturn model", "Electrical particle", "Chemistry term"],
            "IRE": ["Anger", "Wrath", "Fury", "Rage", "Indignation"],
            "ITS": ["Belonging to it", "That thing's", "Possessive of it", "Not it's", "Of it"],
            "IVY": ["Climbing plant", "League plant", "Wall climber", "Poison ___", "College vine"],
            
            # 4-letter words
            "ABLE": ["Capable", "Competent", "Having skill", "Can do", "Qualified"],
            "ACHE": ["Pain", "Hurt", "Throb", "Dull pain", "Yearn"],
            "ACID": ["Sour substance", "LSD", "Battery fluid", "pH below 7", "Corrosive"],
            "ACRE": ["Land measure", "4,840 sq yards", "Farm unit", "Plot size", "Field measure"],
            "AGED": ["Old", "Matured", "Elderly", "Like wine", "Senior"],
            "AJAR": ["Slightly open", "Not shut", "Door position", "Partly open", "Cracked"],
            "ALSO": ["Too", "In addition", "As well", "Besides", "Furthermore"],
            "AMID": ["Among", "In the middle of", "Surrounded by", "During", "Within"],
            "ANTS": ["Picnic pests", "Colony insects", "Small workers", "Hill dwellers", "Six-leggers"],
            "APEX": ["Top", "Peak", "Summit", "Highest point", "Pinnacle"],
            "ARCH": ["Curved structure", "Foot part", "Playfully sly", "Bridge type", "Eyebrow shape"],
            "AREA": ["Region", "Zone", "Space", "District", "Section"],
            "ARMY": ["Military force", "Host", "Large group", "Soldiers", "Ground forces"],
            "ARTS": ["Creative works", "Liberal ___", "Crafts partner", "Cultural studies", "Fine ___"],
            "ATOM": ["Tiny particle", "Molecule part", "Nuclear item", "Basic unit", "Smallest bit"],
            ...
            "BAKE": ["Cook in oven", "Make bread", "Roast", "Heat thoroughly", "Make cookies"],
            "BALL": ["Sphere", "Dance", "Round object", "Good time", "Sports item"],
            "BAND": ["Musical group", "Ring", "Strip", "Unite", "Frequency range"],
            "BANK": ["Financial institution", "River edge", "Rely on", "Tilt", "Money place"],
            "BARE": ["Naked", "Empty", "Minimal", "Expose", "Plain"],
            "BARK": ["Dog sound", "Tree covering", "Yell", "Ship", "Rough call"],
            "BARN": ["Farm building", "Storage structure", "Hay holder", "Cow house", "Rural structure"],
            "BASE": ["Foundation", "Bottom", "Military post", "Starting point", "Alkaline"],
            ...
            "BELL": ["Ringer", "Chime", "Alexander Graham", "Tower item", "Door signal"],
            "BELT": ["Waist strap", "Region", "Hit hard", "Sing loudly", "Asteroid region"],
            ...
            "BILL": ["Invoice", "Duck part", "Paper money", "Proposed law", "Statement"],
            "BIND": ["Tie", "Fasten", "Obligate", "Difficult situation", "Book edge"],
            "BIRD": ["Feathered creature", "Plane", "Shuttlecock", "Oriole or owl", "Flying animal"],
            ...
            "BONE": ["Skeleton part", "Fish hazard", "Study hard", "Ivory source", "Dog treat"],
            "BOOK": ["Volume", "Reserve", "Novel", "Text", "Arrest"],
            "BOOM": ["Loud sound", "Prosper", "Crane arm", "Economic growth", "Thunder"],
            "BOOT": ["Footwear", "Kick out", "Computer start", "Trunk", "Navy recruit"],
            "BORE": ["Drill", "Tedious person", "Make weary", "Gun barrel", "Tidal ___"],
            "BORN": ["Brought into being", "Natural", "Delivered", "Native", "Originated"],
            "BOSS": ["Manager", "Supervisor", "Excellent", "Stud", "Chief"],
            "BOTH": ["Two together", "Each of two", "Equally", "The pair", "One and the other"],
            "BOWL": ["Dish", "Stadium", "Roll a ball", "Super ___", "Soup holder"],
            
            # 5-letter words
            "ABOUT": ["Concerning", "Approximately", "Around", "Near", "On the subject of"],
            "ABOVE": ["Over", "Higher than", "Beyond", "More than", "Overhead"],
            "ABUSE": ["Mistreat", "Misuse", "Harmful treatment", "Insult", "Take advantage"],
            "ACTOR": ["Performer", "Thespian", "Stage player", "Movie star", "One who acts"],
            "ADAPT": ["Adjust", "Modify", "Change to fit", "Make suitable", "Evolve"],
            "ADMIT": ["Confess", "Allow in", "Acknowledge", "Let enter", "Own up"],
            "ADOPT": ["Take as one's own", "Choose", "Take in", "Embrace", "Accept formally"],
            "ADULT": ["Grown-up", "Mature person", "Of age", "Not a child", "Full-grown"],
            "AFTER": ["Following", "Later than", "Behind", "Subsequently", "In pursuit of"],
            "AGAIN": ["Once more", "Anew", "Additionally", "Repeatedly", "Another time"],
            ...
            "ALBUM": ["Photo book", "Record", "Collection", "Music release", "Scrapbook"],
            "ALERT": ["Watchful", "Warning", "Quick", "Awake", "On guard"],
            "ALIEN": ["Foreign", "Extraterrestrial", "Strange", "Outsider", "From space"],
            ...
            "ALPHA": ["First Greek letter", "Beginning", "Top dog", "Leader", "Primary"],
            "ALTER": ["Change", "Modify", "Adjust", "Transform", "Revise"],
            "ANGEL": ["Heavenly being", "Good person", "Guardian spirit", "Investor", "Cherub"],
            ...
            "ANKLE": ["Foot joint", "Leg part", "Above the foot", "Sock top", "Sprain site"],
            "ANNEX": ["Add on", "Extension", "Attach", "Building addition", "Take over"],
            ...
            "APPLE": ["Fruit", "Computer company", "NYC nickname", "Pie fruit", "Teacher's gift"],
            "APPLY": ["Put on", "Request", "Use", "Be relevant", "Submit application"],
            "APRIL": ["Fourth month", "Spring month", "Shower month", "After March", "Easter month"],
            "APRON": ["Kitchen wear", "Protective garment", "Chef's cover", "Airport area", "Stage front"],
            "ARGUE": ["Debate", "Dispute", "Quarrel", "Make a case", "Disagree"],
            "ARISE": ["Get up", "Occur", "Stand up", "Come about", "Originate"],
            "ARMED": ["Carrying weapons", "Equipped", "Military", "With guns", "Prepared for war"],
            "AROMA": ["Scent", "Fragrance", "Smell", "Perfume", "Pleasant odor"],
            "ARRAY": ["Display", "Arrangement", "Collection", "Line up", "Impressive group"],
            "ARROW": ["Pointer", "Bow missile", "Direction indicator", "Cupid's weapon", "Sign"],
            "ARSON": ["Fire crime", "Burning crime", "Deliberate fire", "Pyromania act", "Insurance fraud"],
            "ASIDE": ["To one side", "Apart", "Digression", "Stage whisper", "Away"],
            "ASSET": ["Valuable item", "Resource", "Advantage", "Property", "Plus"],
            "ATLAS": ["Map book", "World holder", "Geography book", "Titan", "Reference book"],
            "ATTIC": ["Top floor", "Storage space", "Garret", "Loft", "Upper room"],
            "AUDIO": ["Sound", "Hearing-related", "Not video", "Recording", "Sonic"],
            "AUDIT": ["Financial review", "Examine", "Verify accounts", "Check books", "Inspection"],
        ...
        self.pattern_clues = {
            "ING": ["Action word", "Present participle", "Verb form", "-ing word", "Continuous action"],
            "ER": ["Person who", "More than", "Comparative ending", "One who does", "Agent suffix"],
            "ED": ["Past tense", "Already done", "Completed action", "Verb ending", "Historical"],
            "LY": ["Adverb ending", "In a way", "Manner of", "How it's done", "Descriptive ending"],
            "EST": ["Most", "Superlative", "To the greatest degree", "Supreme", "Ultimate form"],
            "TION": ["Action result", "Process", "State of being", "Noun ending", "Abstract concept"],
            "NESS": ["Quality of being", "State of", "Condition", "Abstract quality", "Noun suffix"],
            "MENT": ["Result of", "Action outcome", "Process result", "State", "Noun ending"],
            "ABLE": ["Can be done", "Capable of being", "Possible to", "Worthy of", "Fit for"],
            "LESS": ["Without", "Lacking", "Free from", "Absence of", "Not having"],
            "FUL": ["Full of", "Having quality of", "Characterized by", "Tending to", "Having"],
            "ISH": ["Somewhat", "Like", "Approximately", "Having quality of", "Tending toward"],
            "WARD": ["In direction of", "Toward", "Facing", "Moving to", "Oriented"],
            "WISE": ["In manner of", "With respect to", "Regarding", "In direction of", "Smart"]
        }
        
        # Thematic clues for specific topics
        self.theme_clues = {
            "ANIMAL": ["Living creature", "Zoo resident", "Pet or wild", "Fauna member", "Non-plant organism"],
            ...
            "SPORT": ["Athletic activity", "Game", "Competition", "Physical contest", "Recreation"],
            "MUSIC": ["Sound art", "Melody", "Rhythmic sounds", "Concert content", "Audio art"],
            "WEATHER": ["Climate condition", "Atmospheric state", "Forecast subject", "Sky status", "Meteorology"],
            "GEOGRAPHY": ["Earth study", "Location science", "Map subject", "Place study", "World features"],
            "SCIENCE": ["Knowledge field", "Research area", "Natural study", "Lab work", "Discovery field"],
            "HISTORY": ["Past events", "What happened", "Chronicle", "Former times", "Historical record"]
        }

    def get_clue(self, word: str, difficulty: str = "medium", puzzle_num: int = 1, used_clues: Optional[set] = None) -> str:
        """
    ...
    def _generate_pattern_clue(self, word: str, difficulty: str, puzzle_num: int) -> str:
        ...
        if compound_parts:
            ...
            if part1 in self.clue_database and part2 in self.clue_database:
                return f"{self.clue_database[part1][0]} + {self.clue_database[part2][0]}"
    ...
    def _get_theme_clue(self, word: str, difficulty: str) -> Optional[str]:
        ...
        # Animal names
        animals = ["BEAR", "WOLF", "LION", "TIGER", "EAGLE", "HAWK", "DEER", "MOOSE", "OTTER", "SEAL"]
        if word in animals:
            if difficulty == "easy":
                return f"Wild animal"
            elif difficulty == "hard":
                return f"Forest dweller" if word in ["BEAR", "WOLF", "DEER", "MOOSE"] else "Predator"
            else:
