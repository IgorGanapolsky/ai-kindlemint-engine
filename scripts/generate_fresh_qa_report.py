...
def generate_fresh_qa_report():
    ...
    # File paths
    complete_book_path = Path("books/active_production/Large_Print_Sudoku_Masters/volume_1/paperback/Large_Print_Sudoku_Masters_V1_COMPLETE.pdf")
    qa_report_path = Path("books/active_production/Large_Print_Sudoku_Masters/volume_1/paperback/FRESH_QA_REPORT_COMPLETE_BOOK.json")
    ...
    qa_report = {
        ...
        "info": [
            ...
            {
                "type": "SUCCESS",
                "description": "Professional large print formatting"
            }
        ],
        "checks": {
            "file_properties": {
