...
def regenerate_all_puzzles():
    ...
    puzzle_dir = Path("books/active_production/Large_Print_Sudoku_Masters/volume_1/puzzles")
    ...
    for json_file in json_files:
        try:
            ...
            puzzle_path = engine.create_grid_image(initial_grid, puzzle_id, is_solution=False)
            
            # Regenerate solution image 
            solution_path = engine.create_grid_image(solution_grid, puzzle_id, is_solution=True)
