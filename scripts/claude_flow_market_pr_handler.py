...
def analyze_market_pr():
    ...
    try:
        ...
        print(f"✅ Decision: {'AUTO-MERGE' if decision['auto_merge'] else 'MANUAL REVIEW'}")
    ...
    if decision['auto_merge']:
        ...
        for niche in decision['selected_niches']:
            ...
            task_cmd = [
                "./claude-flow", "task", "create", "content",
        ...
        print(f"Reason: {decision.get('reasoning', 'Opportunities need further evaluation')}")
