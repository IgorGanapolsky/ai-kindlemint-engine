...
UNIQUE_PUZZLES = [
    # Puzzle 1: Animals
    {
        ...
        "across_clues": {
            1: "Feline pet", 4: "Canine companion", 6: "Soaring bird",
            8: "King of beasts", 9: "Pack hunter", 10: "Striped cat",
            11: "Hibernating mammal", 12: "Ocean predator",
            13: "Small rodent", 14: "Hopping pet",
            15: "Reptile that slithers", 16: "Equine animal",
            17: "Playful water mammal", 18: "African striped animal",
            19: "Large marine mammal", 20: "Farm animal",
            21: "Swamp reptile", 22: "Mountain climber"
        },
        "down_clues": {
            1: "Young cow", 2: "Monkey relative", 3: "Domesticated bird",
            4: "Waterfowl", 5: "Wise bird", 6: "Forest animal",
            7: "Australian jumper", 11: "Honey maker", 12: "Slow reptile",
            13: "Arctic bear", 14: "Colorful bird", 15: "Tallest animal"
        }
    },
    # Puzzle 2: Food & Cooking
    {
        ...
        "across_clues": {
            1: "Bakery staple", 3: "Hot liquid meal", 5: "Birthday dessert",
            7: "Breakfast protein", 8: "Green mix", 9: "Beef or pork",
            10: "Evening meal", 11: "Dairy product",
            12: "Apple or orange", 13: "Asian grain", 14: "Ocean protein",
            15: "Cultured dairy", 16: "Italian noodles",
            17: "Italian pie", 18: "Mexican shells",
            19: "Sweet treat", 20: "Legumes",
            21: "Citrus fruit", 22: "Tree snacks", 23: "Seasoning"
        },
        "down_clues": {
            1: "Morning meal", 2: "Hot beverage", 3: "Kitchen tool",
            4: "Eating utensil", 5: "Sweet topping", 6: "Green vegetable",
            7: "Root vegetable", 8: "Leafy green", 9: "Cooking fat",
            10: "Sweet fruit", 11: "Sour condiment", 12: "Frozen dessert"
        }
    },
    # Puzzle 3: Cities & Travel
    {
        ...
        "across_clues": {
            1: "French capital", 4: "British capital",
            6: "Italian capital", 7: "Russian capital",
            8: "Australian city", 9: "Japanese capital",
            10: "German capital", 11: "Big Apple city",
            12: "Greek capital", 13: "Egyptian capital",
            14: "Asian country", 15: "European country",
            16: "Swiss city", 17: "Norwegian capital",
            18: "UAE city", 19: "English city"
        },
        "down_clues": {
            1: "Chinese capital", 2: "Spanish capital", 3: "Irish capital",
            4: "Portuguese capital", 5: "Dutch capital", 6: "Austrian capital",
            7: "Danish capital", 8: "Finnish capital", 9: "Belgian capital",
            10: "Swedish capital", 11: "Polish capital", 12: "Czech capital"
        }
    },
    # Puzzle 4: Music & Arts
    {
        ...
        "across_clues": {
            1: "88-key instrument", 3: "Music genre", 5: "Musical piece",
            7: "Creative person", 8: "String instrument",
            9: "Classical performance", 10: "Six-string instrument",
            11: "Bowed instrument", 12: "Brass instrument",
            13: "Large ensemble", 14: "Musical speed",
            15: "Music genre", 16: "Classical composition",
            17: "Percussion set", 18: "Musical symbols",
            19: "Dance form", 20: "Artist workplace"
        },
        "down_clues": {
            1: "Canvas creator", 2: "Art display place", 3: "Singing group",
            4: "High male voice", 5: "Low male voice", 6: "Female voice",
            7: "Music notation", 8: "Beat pattern", 9: "Sound quality",
            10: "Loudness level", 11: "Music practice", 12: "Stage show"
        }
    },
    # Puzzle 5: Science & Nature
    {
        ...
        "across_clues": {
            1: "Smallest unit", 3: "Living unit", 5: "Celestial body",
            7: "Breathing gas", 8: "Electromagnetic wave",
            9: "Chemical combination", 10: "Power source", 11: "Element 6",
            12: "Negative particle", 13: "Planet path",
            14: "Force of attraction", 15: "Scientific explanation",
            16: "Nuclear particle", 17: "Light particle", 18: "Atomic center"
        },
        "down_clues": {
            1: "Weather conditions", 2: "Plant process", 3: "Animal group",
            4: "Water cycle part", 5: "Rock type", 6: "Tree part",
            7: "Ocean movement", 8: "Cloud type", 9: "Wind storm",
            10: "Frozen rain", 11: "Morning moisture", 12: "Rainbow maker"
        }
    },
...
def generate_remaining_puzzles():
    ...
    themes = [
        "Sports & Games", "Technology", "Literature", "History", "Movies & TV",
        "Fashion", "Weather", "Transportation", "Holidays", "Occupations",
        "Colors & Shapes", "Numbers & Math", "Emotions", "School Subjects", "Hobbies",
        "Garden & Plants", "Ocean Life", "Mountains", "Desserts", "Beverages",
        "Tools & Hardware", "Furniture", "Clothing", "Body Parts", "Languages",
        "Countries", "Rivers & Lakes", "Space", "Mythology", "Seasons",
        "Flowers", "Trees", "Birds", "Insects", "Reptiles",
        "Weather Events", "Kitchen Items", "Office Supplies", "Sports Equipment", "Musical Terms",
        "Dance Styles", "Art Movements", "Architecture", "Gemstones", "Metals"
    ]
    
    word_banks = {
        "Sports & Games": ["SOCCER", "TENNIS", "GOLF", "CHESS", "POKER", "RUGBY", "HOCKEY", "BOXING"],
        "Technology": ["COMPUTER", "ROBOT", "LASER", "MODEM", "SERVER", "PIXEL", "BINARY", "CACHE"],
        "Literature": ["NOVEL", "POETRY", "PROSE", "VERSE", "THEME", "PLOT", "HERO", "AUTHOR"],
...
def create_pdf(puzzles, output_path):
    ...
    for i in range(1, 26):
        ...
        if i + 25 <= 50:
            c.drawString(PAGE_WIDTH/2, y_position, f"Puzzle {i+25}: {puzzles[i+24]['theme']}")
        y_position -= 20
    ...
    for puzzle_num in range(1, 51):
        ...
        c.drawCentredString(PAGE_WIDTH/2, PAGE_HEIGHT - 72, f"Puzzle {puzzle_num}: {puzzle['theme']}")
        ...
        for row in range(GRID_SIZE):
            for col in range(GRID_SIZE):
                ...
                if puzzle['grid'][row][col] == '#':
                    ...
                    if (col == 0 or puzzle['grid'][row][col-1] == '#') and col < 14 and puzzle['grid'][row][col+1] != '#':
                        number = (row * 2) + 1
...
def main():
    ...
    # Generate PDF
    output_path = paperback_dir / "Large_Print_Crossword_Masters_-_Volume_3_interior_FINAL.pdf"
