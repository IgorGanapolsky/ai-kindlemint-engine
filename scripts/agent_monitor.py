    ...
    def print_dashboard(self):
        ...
        if processes:
            ...
            for proc in processes[:5]:  # Show top 5
                print(f"   • PID {proc['pid']} - CPU: {proc['cpu']}% - Memory: {proc['memory']}%")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Monitor Claude Code agent orchestration")
    ...
    parser.add_argument("--output", "-o", type=str, help="Output filename for status report")
