...
def add_config_import(content):
    ...
    config_import_exists = any('from scripts.config_loader import config' in line or 
                              'from config_loader import config' in line 
                              for line in lines)
...
def main():
    parser = argparse.ArgumentParser(description="Refactor hardcoded values to use configuration")
    parser.add_argument('--dry-run', action='store_true', help="Show what would be changed without modifying files")
    parser.add_argument('--file', help="Refactor a specific file")
    parser.add_argument('--all', action='store_true', help="Refactor all known files with hardcoded values")
