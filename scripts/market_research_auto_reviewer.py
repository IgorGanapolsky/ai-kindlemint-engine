...
class MarketResearchAutoReviewer:
            ...
            try:
                with open(files['csv'], 'r') as f:
                    ...
                    for row in reader:
                        ...
                        analysis['market_trends'][trend] = analysis['market_trends'].get(trend, 0) + 1
            except Exception as e:
    ...
    def _make_decisions(self, analysis: Dict) -> Dict:
        ...
        if analysis['viable_niches'] >= 3 and analysis['top_scores'][0] >= 0.8:
            ...
            decisions['reasoning'].append(f"Found {analysis['viable_niches']} high-quality opportunities")
            decisions['reasoning'].append(f"Top opportunity score: {analysis['top_scores'][0]}")
            ...
            decisions['reasoning'].append(f"Best score: {analysis['top_scores'][0] if analysis['top_scores'] else 0}")
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Automated Market Research PR Reviewer')
    parser.add_argument('--pr', type=str, help='PR number to review')
    parser.add_argument('--auto', action='store_true', help='Enable fully automated mode')
