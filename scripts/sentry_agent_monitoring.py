...
import sentry_sdk
from sentry_sdk import Hub, start_transaction, set_tag, set_context
from sentry_sdk.integrations.openai import OpenAIIntegration

# Import the existing Sentry config
from .sentry_config import init_sentry, add_breadcrumb
...
class SentryAgentMonitor:
    ...
    def _init_enhanced_sentry(self):
        ...
        with sentry_sdk.configure_scope() as scope:
            ...
            scope.set_context("ai_configuration", {
    ...
    def track_tool_call(self, agent_id: str, tool_name: str, 
                       tool_input: Dict[str, Any], tool_output: Any = None,
    ...
    def capture_ai_error(self, agent_id: str, error: Exception, 
...
class AgentTransaction:
    ...
    def __exit__(self, exc_type, exc_val, exc_tb):
        if exc_type:
            self.monitor.capture_ai_error(
                ...
                exc_val,
                {"transaction": self.context.task_name}
            )
    ...
    def track_prompt(self, prompt: str, response: str = None, 
    ...
    with monitor.start_agent(context) as transaction:
        ...
        try:
            ...
            monitor.capture_ai_error(
                context.agent_id,
                e,
                {"step": "clue_validation", "clue_index": 3}
            )
