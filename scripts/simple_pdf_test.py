...
def create_test_pdf():
    ...
    puzzle_image = Path("books/active_production/Large_Print_Sudoku_Masters/volume_1/puzzles/sudoku_puzzle_100.png")
    ...
    # Create test PDF
    test_pdf_path = Path("books/active_production/Large_Print_Sudoku_Masters/volume_1/paperback/TEST_PUZZLE_100.pdf")
    ...
    if puzzle_image.exists():
        ...
        c.drawCentredString(width / 2, y - 0.5 * inch, "If fix worked: Clues should be BOLD, empty cells should have light background")
