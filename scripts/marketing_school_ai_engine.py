...
class MarketingSchoolAIEngine:
    ...
    def __init__(self, book_config: Dict, book_artifacts: Dict):
        ...
        self.output_dir = Path(f"books/active_production/{self.series_name}/volume_{self.volume}/marketing_school")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Marketing School AI Engine for KindleMint")
