...
class CrosswordQAValidator:
    ...
    def _load_dictionary(self) -> Set[str]:
        ...
        common_words = {
            ...
            "MAY", "NEW", "NOW", "OLD", "SEE", "TWO", "WAY", "WHO", "OIL", "USE",
            "CAT", "DOG", "MAN", "CAR", "EAT", "FAR", "FUN", "GET", "GOT", "LET",
            "PUT", "RAN", "RED", "RUN", "SIT", "TEN", "TOP", "TOO", "WIN", "YES",
            "AGE", "AGO", "AIR", "ARM", "ART", "ASK", "BAD", "BAG", "BAR", "BED",
            "BIG", "BOX", "BOY", "BUS", "BUY", "CUP", "CUT", "DAD", "DID", "DIE",
            "EAR", "END", "EYE", "FEW", "FLY", "GOD", "GUN", "GUY", "HIT", "HOT",
            "JOB", "LAW", "LAY", "LEG", "LIE", "LOT", "LOW", "MAD", "MAP", "MOM",
            "PAY", "SAW", "SAY", "SET", "SHE", "SIX", "SON", "SUN", "TAX", "TEA",
            "TRY", "VAN", "WAR", "WET", "WHY", "WON", "YET", "ZOO", "ACE", "ACT",
            "ADD", "AID", "AIM", "ANT", "ANY", "APE", "ATE", "BAT", "BEE", "BET",
            "BIT", "BOW", "BOY", "BUD", "BUG", "BUM", "BUN", "BUS", "CAB", "CAM",
            # 4-letter words
            "THAT", "WITH", "HAVE", "THIS", "WILL", "YOUR", "FROM", "THEY", "KNOW",
            "WANT", "BEEN", "GOOD", "MUCH", "SOME", "TIME", "VERY", "WHEN", "COME",
            "HERE", "JUST", "LIKE", "LONG", "MAKE", "MANY", "OVER", "SUCH", "TAKE",
            "THAN", "THEM", "WELL", "ONLY", "YEAR", "WORK", "BACK", "CALL", "CAME",
            ...
            "TELL", "TURN", "USED", "WANT", "WAYS", "WEEK", "WENT", "WERE", "WHAT",
            "WORD", "WORK", "YEAR", "ABLE", "AGED", "ALSO", "AREA", "ARMY", "AWAY",
            "BABY", "BASE", "BEAR", "BEAT", "BEEN", "BEST", "BILL", "BIRD", "BLUE",
            "BOAT", "BODY", "BOOK", "BORN", "BOTH", "BOWL", "BOYS", "BUSY", "CAKE",
            "CALM", "CARD", "CARE", "CARS", "CASE", "CASH", "CAST", "CELL", "CITY",
            "CLUB", "COAL", "COAT", "COLD", "COPY", "CORE", "COST", "CREW", "DARK",
            "DATA", "DATE", "DAYS", "DEAD", "DEAL", "DEAR", "DEEP", "DIET", "DOOR",
            "DOWN", "DRAW", "DREW", "DROP", "DRUG", "DUTY", "EACH", "EARN", "EASE",
            "EAST", "EASY", "EDGE", "ELSE", "EVEN", "EVER", "EYES", "FACE", "FACT",
            "FAIL", "FAIR", "FALL", "FARM", "FAST", "FEAR", "FEED", "FEEL", "FEET",
            "FELL", "FELT", "FILE", "FILL", "FILM", "FINE", "FIRE", "FIRM", "FISH",
            "FIVE", "FLAT", "FLOW", "FOOD", "FOOT", "FORM", "FORT", "FOUR", "FREE",
            "FROM", "FUEL", "FULL", "FUND", "GAIN", "GAME", "GATE", "GAVE", "GEAR",
            "GIFT", "GIRL", "GIVE", "GLAD", "GOAL", "GOES", "GOLD", "GONE", "GOOD",
            "GRAY", "GREW", "GROW", "GULF", "GUNS", "HAIR", "HALF", "HALL", "HAND",
            ...
            "INCH", "INTO", "IRON", "ITEM", "JACK", "JANE", "JOBS", "JOHN", "JOIN",
            "JUMP", "JURY", "JUST", "KEEP", "KEPT", "KILL", "KIND", "KING", "KNEE",
            "KNEW", "KNOW", "LACK", "LADY", "LAID", "LAKE", "LAND", "LANE", "LAST",
            "LATE", "LEAD", "LEFT", "LEND", "LESS", "LIFE", "LIFT", "LIKE", "LINE",
            "LINK", "LIST", "LIVE", "LOAD", "LOAN", "LOCK", "LONG", "LOOK", "LORD",
            "LOSE", "LOSS", "LOST", "LOTS", "LOUD", "LOVE", "LUCK", "MADE", "MAIL",
            "MAIN", "MAKE", "MALE", "MALL", "MANY", "MARK", "MASS", "MATE", "MEAL",
            "MEAN", "MEAT", "MEET", "MENU", "MERE", "MIKE", "MILE", "MILK", "MIND",
            "MINE", "MISS", "MODE", "MOOD", "MOON", "MORE", "MOST", "MOVE", "MUCH",
            "MUST", "NAME", "NAVY", "NEAR", "NECK", "NEED", "NEWS", "NEXT", "NICE",
            "NINE", "NONE", "NOON", "NORM", "NOSE", "NOTE", "OKAY", "ONCE", "ONES",
            "ONLY", "ONTO", "OPEN", "ORAL", "OVER", "PACE", "PACK", "PAGE", "PAID",
            "PAIN", "PAIR", "PALE", "PALM", "PARK", "PART", "PASS", "PAST", "PATH",
            "PAUL", "PEAK", "PICK", "PILE", "PINE", "PINK", "PIPE", "PLAN", "PLAY",
            "PLOT", "PLUS", "POEM", "POET", "POLL", "POOL", "POOR", "PORT", "POST",
            "POUR", "PREY", "PULL", "PURE", "PUSH", "RACE", "RAIL", "RAIN", "RANK",
            "RARE", "RATE", "READ", "REAL", "REAR", "RELY", "RENT", "REST", "RICE",
            "RICH", "RIDE", "RING", "RISE", "RISK", "ROAD", "ROCK", "RODE", "ROLE",
            "ROLL", "ROOF", "ROOM", "ROOT", "ROPE", "ROSE", "RULE", "RUSH", "RUTH",
            ...
            "TALK", "TALL", "TANK", "TAPE", "TASK", "TEAM", "TECH", "TEEN", "TELL",
            "TEND", "TERM", "TEST", "TEXT", "THAN", "THAT", "THEM", "THEN", "THEY",
            "THIN", "THIS", "THUS", "TIDE", "TIED", "TIES", "TIME", "TINY", "TIRE",
            "TOLD", "TOLL", "TONE", "TONY", "TOOK", "TOOL", "TOPS", "TORE", "TORN",
            "TOUR", "TOWN", "TOYS", "TREE", "TRIM", "TRIP", "TRUE", "TUBE", "TUNE",
            "TURN", "TWIN", "TYPE", "UNIT", "UPON", "USED", "USER", "VARY", "VAST",
            "VERY", "VIEW", "VOTE", "WAGE", "WAIT", "WAKE", "WALK", "WALL", "WANT",
            "WARD", "WARM", "WARN", "WASH", "WAVE", "WAYS", "WEAK", "WEAR", "WEEK",
            "WELL", "WENT", "WERE", "WEST", "WHAT", "WHEN", "WHOM", "WIDE", "WIFE",
            "WILD", "WILL", "WIND", "WINE", "WING", "WINS", "WIRE", "WISE", "WISH",
            "WITH", "WOOD", "WORD", "WORE", "WORK", "WORN", "YARD", "YEAH", "YEAR",
            "YOUR", "ZERO", "ZONE",
            # 5-letter words
            "WHICH", "THEIR", "WOULD", "THERE", "COULD", "BEING", "FIRST", "AFTER",
            "THESE", "OTHER", "WORDS", "WORLD", "WHERE", "STILL", "THREE", "HOUSE",
            "FOUND", "GOING", "EVERY", "UNDER", "NEVER", "PLACE", "THINK", "WHILE",
            "GREAT", "AGAIN", "BEFORE", "SMALL", "THROUGH", "TURNED", "INTEREST",
            "LARGE", "ALONG", "AMONG", "ASKED", "BEHIND", "BETTER", "BLACK", "BRING",
            "BUILD", "CARRY", "CLEAN", "CLOSE", "COMES", "COURT", "DIDN'T", "EARLY",
            "FIELD", "FINAL", "FORCE", "FRONT", "GIVEN", "GREEN", "HANDS", "HEART",
            "HEAVY", "HUMAN", "LEAVE", "LEVEL", "LIGHT", "LOCAL", "MEANS", "MIGHT",
            "MONEY", "MONTH", "MUSIC", "NIGHT", "NORTH", "OFTEN", "ORDER", "PAPER",
            "PARTY", "PEACE", "PEOPLE", "PERHAPS", "PERSON", "PIECE", "POINT", "POWER",
            "QUITE", "REACH", "RIGHT", "RIVER", "ROUND", "SEEMS", "SENSE", "SHALL",
            "SHORT", "SHOWN", "SINCE", "SOUTH", "SPACE", "SPEAK", "SPENT", "STAFF",
            "STAGE", "START", "STATE", "STOOD", "STORY", "STUDY", "TAKEN", "THANK",
            "THIRD", "THOSE", "THOUGH", "TODAY", "TRADE", "TRIED", "TRYING", "TURNED",
            "UNTIL", "USING", "VALUE", "VOICE", "WATER", "WEEKS", "WHERE", "WHICH",
            "WHILE", "WHITE", "WHOLE", "WHOSE", "WOMAN", "WOMEN", "WORKS", "WORTH",
            "WOULD", "WRITE", "WRONG", "YEARS", "YOUNG", "ABOVE", "ADDED", "ADMIT",
            "ADULT", "AFTER", "AGENT", "AGREE", "AHEAD", "ALIVE", "ALLOW", "ALONE",
            "ALREADY", "ALTHOUGH", "ALWAYS", "AMONG", "ANGER", "ANGLE", "ANGRY", "APART",
            "APPLE", "APPLY", "AREAS", "ARGUE", "ARISE", "ARMED", "ASIDE", "ASKED",
            "AVOID", "AWARE", "BADLY", "BAKER", "BASED", "BASIC", "BEACH", "BEGAN",
            "BEGIN", "BEING", "BELOW", "BENCH", "BILLY", "BIRTH", "BLOCK", "BLOOD",
            "BOARD", "BOOKS", "BOOST", "BOOTH", "BOUND", "BRAIN", "BRAND", "BREAD",
            "BREAK", "BREED", "BRIEF", "BRING", "BROAD", "BROKE", "BROWN", "BUILD",
            "BUILT", "BUYER", "CABLE", "CALIF", "CALLS", "CARRY", "CASES", "CATCH",
            "CAUSE", "CHAIN", "CHAIR", "CHAOS", "CHARM", "CHART", "CHASE", "CHEAP",
            "CHECK", "CHEST", "CHIEF", "CHILD", "CHINA", "CHOSE", "CHRIS", "CIVIL",
            "CLAIM", "CLASS", "CLEAN", "CLEAR", "CLICK", "CLIMB", "CLOCK", "CLOSE",
            "CLOUD", "COACH", "COAST", "COLON", "COLOR", "COMIC", "COUGH", "COULD",
            "COUNT", "COUPLE", "COURSE", "COURT", "COVER", "CRACK", "CRAFT", "CRASH",
            "CRAZY", "CREAM", "CRIME", "CROSS", "CROWD", "CROWN", "CRUDE", "CURVE",
            "CYCLE", "DAILY", "DANCE", "DATED", "DEALT", "DEATH", "DEBUT", "DELAY",
            "DELTA", "DENSE", "DEPOT", "DEPTH", "DERBY", "DIGIT", "DIRTY", "DOESN",
            "DOING", "DOUBT", "DOZEN", "DRAFT", "DRAIN", "DRAMA", "DRANK", "DRAWN",
            "DREAM", "DRESS", "DRIED", "DRILL", "DRINK", "DRIVE", "DROVE", "DYING",
            "EAGER", "EARLY", "EARTH", "EIGHT", "EIGHT", "EITHER", "ELDER", "ELECT",
            "ELITE", "EMPTY", "ENEMY", "ENJOY", "ENTER", "ENTRY", "EQUAL", "ERROR",
            "ETHAN", "ETHICS", "EVANS", "EVENT", "EVERY", "EXACT", "EXIST", "EXTRA",
            "FACED", "FACES", "FACTS", "FAITH", "FALLS", "FALSE", "FAMED", "FANCY",
            # 6-letter words
            "BEFORE", "SHOULD", "PEOPLE", "THROUGH", "AROUND", "ANOTHER", "BETWEEN",
            "BECAUSE", "WITHOUT", "THOUGHT", "GENERAL", "HOWEVER", "NOTHING", "PERHAPS",
            "PROBLEM", "SEVERAL", "TOGETHER", "IMPORTANT", "CHILDREN", "MORNING", "NOTHING",
            "HIMSELF", "LOOKING", "SOMETHING", "WHETHER", "PRESENT", "FOLLOWING", "WITHOUT",
            "ACTUALLY", "AGAINST", "ALREADY", "ALTHOUGH", "AMERICA", "ANOTHER", "ANYTHING",
            "BROUGHT", "BUILDING", "BUSINESS", "CERTAIN", "COMPANY", "CONTROL", "COUNTRY",
            "DEVELOP", "DIFFERENT", "DURING", "ECONOMIC", "EITHER", "ENOUGH", "ESPECIALLY",
            "EXAMPLE", "FAMILY", "FATHER", "FEDERAL", "FORMER", "FURTHER", "GENERAL", "GETTING",
            "GOVERNMENT", "HAVING", "HEALTH", "HERSELF", "HISTORY", "HOWEVER", "HUNDRED",
            "IMPORTANT", "INCLUDING", "INCREASE", "INTEREST", "ITSELF", "LITTLE", "LIVING",
            "LOOKING", "MAKING", "MATTER", "MEMBER", "MILLION", "MINUTES", "MOMENT", "MOTHER",
            "MYSELF", "NATIONAL", "NATURE", "NECESSARY", "NOTHING", "NUMBER", "OFFICE", "OUTSIDE",
            "PARENTS", "PERHAPS", "PERIOD", "PERSON", "PICTURE", "PLAYING", "POLITICAL", "POSITION",
            "POSSIBLE", "PRESENT", "PRESIDENT", "PRIVATE", "PROBABLY", "PROBLEM", "PROCESS",
            "PROGRAM", "PUBLIC", "QUESTION", "RATHER", "REALLY", "REASON", "RECENT", "RECORD",
            "REPORT", "RESULT", "RETURN", "SAYING", "SCHOOL", "SECOND", "SEEING", "SEEMED",
            "SERIOUS", "SERVICE", "SEVERAL", "SHOULD", "SIMPLE", "SINGLE", "SOCIAL", "SOCIETY",
            "SOMEONE", "SPECIAL", "STARTED", "STATES", "STREET", "STRONG", "STUDENT", "SUBJECT",
            "SYSTEM", "TAKING", "THINGS", "THINKING", "THOUGH", "THOUGHT", "THROUGH", "TOGETHER",
            "TOWARD", "TRYING", "TURNED", "UNDERSTAND", "UNITED", "UNIVERSITY", "USUALLY", "VALUES",
            "VARIOUS", "WALKED", "WANTED", "WASHINGTON", "WATCHING", "WATER", "WHETHER", "WITHIN",
            "WITHOUT", "WORKING", "WRITING", "WRITTEN", "YESTERDAY",
            # 7-letter words
            "BECAUSE", "THROUGH", "BETWEEN", "ANOTHER", "AGAINST", "WITHOUT", "NOTHING",
            "PERHAPS", "PROBLEM", "SEVERAL", "TOGETHER", "ALREADY", "CERTAIN", "COUNTRY",
            "GENERAL", "HOWEVER", "LOOKING", "MORNING", "HIMSELF", "BELIEVE", "BROUGHT",
            "COMPANY", "CONTROL", "GETTING", "ANYTHING", "EXAMPLE", "FOLLOWING", "QUESTION",
            "INTEREST", "BUSINESS", "PROGRAM", "POSSIBLE", "IMPORTANT", "REMEMBER", "CHILDREN",
            "STUDENTS", "AMERICAN", "NATIONAL", "BUILDING", "SPECIAL", "ACTUALLY", "AVAILABLE",
            "EVIDENCE", "FUNCTION", "LANGUAGE", "PERSONAL", "POSITION", "PROBABLY", "RESEARCH",
            "SERVICES", "SOMETHING", "THOUGHT", "WHETHER", "ADDITION", "ALTHOUGH", "APPROACH",
            "ATTENTION", "BEHAVIOR", "COMMUNITY", "COMPLETE", "COMPUTER", "CONSIDER", "CONTINUE",
            "DECISION", "DESCRIBE", "DEVELOP", "DIFFERENT", "DISCOVER", "ECONOMIC", "EDUCATION",
            "ESTABLISH", "EVERYONE", "EXERCISE", "EXPERIENCE", "FINANCIAL", "FOLLOWING", "GOVERNMENT",
            "HAPPENED", "HOSPITAL", "INCREASE", "INDIVIDUAL", "INDUSTRY", "INFLUENCE", "INFORMATION",
            "KNOWLEDGE", "LEARNING", "MATERIAL", "MEDICINE", "MILITARY", "MOVEMENT", "NECESSARY",
            "OPPORTUNITY", "ORIGINAL", "PARTICULAR", "PERFORMANCE", "PHYSICAL", "POLITICAL",
            "POPULATION", "PRACTICE", "PRESSURE", "PROBABLY", "PRODUCE", "PROPERTY", "PROTECT",
            "PROVIDE", "PURPOSE", "QUALITY", "QUESTION", "RECENTLY", "RECOGNIZE", "RELATIONSHIP",
            "RELIGION", "REMEMBER", "REPRESENT", "RESOURCE", "RESPONSE", "SECURITY", "SENTENCE",
            "SITUATION", "SOCIETY", "SPECIFIC", "STANDARD", "STATEMENT", "STRUCTURE", "STUDENT",
            "SUCCESS", "SUPPORT", "SURFACE", "TECHNOLOGY", "THOUSAND", "THROUGHOUT", "TOMORROW",
            "TRAINING", "TREATMENT", "UNDERSTAND", "UNIVERSITY", "VARIOUS", "WHATEVER", "YOURSELF"
        }
    ...
    def _validate_solutions(self, puzzles: List[PuzzleData]) -> List[ValidationResult]:
        ...
        for puzzle in puzzles:
            ...
            for row in range(15):
                for col in range(15):
                    if puzzle.grid[row][col] == '#' and puzzle.solution[row][col] != '#':
                        pattern_matches = False
                    elif puzzle.grid[row][col] != '#' and puzzle.solution[row][col] == '#':
                        pattern_matches = False
            ...
            for row in range(15):
                for col in range(15):
                    if puzzle.solution[row][col] not in ['#'] and not puzzle.solution[row][col].isalpha():
                        empty_cells += 1
    ...
    def _validate_consistency(self, puzzles: List[PuzzleData]) -> List[ValidationResult]:
    ...
    def _extract_words_from_solution(self, solution: List[List[str]]) -> List[Tuple[str, str]]:
    ...
    def _generate_report(self, pdf_path: Path, results: List[ValidationResult], score: int) -> Dict:
    ...
    def _generate_recommendations(self, results: List[ValidationResult]) -> List[str]:
        ...
        structure_fails = [r for r in results if r.category == 'structure' and not r.passed]
        if structure_fails:
            recommendations.append("Review grid patterns - ensure proper symmetry and connectivity")
        
        word_fails = [r for r in results if r.category == 'words' and not r.passed]
        if word_fails:
            recommendations.append("Validate all words against dictionary before generation")
        
        clue_fails = [r for r in results if r.category == 'clues' and not r.passed]
        if clue_fails:
            recommendations.append("Ensure balanced ACROSS/DOWN distribution (35-65% each)")
        
        solution_fails = [r for r in results if r.category == 'solutions' and not r.passed]
        if solution_fails:
            recommendations.append("Verify all solution grids are complete with valid letters")
...
def main():
    ...
    print(f"Score: {report['final_score']}/100 (Pass threshold: {report['pass_threshold']})")
    print(f"\nSummary:")
    ...
    if report['warnings']:
        ...
        for warning in report['warnings']:
            print(f"  - [{warning['category']}] {warning['message']} (score: {warning['score']})")
    
    print(f"\n📊 Category Breakdown:")
    for category, data in report['category_breakdown'].items():
        print(f"  {category.upper()}: {data['average_score']:.1f}/100 (weight: {data['weight']}%)")
