...
class AgentRegistry:
    ...
    async def update_agent_health(self, agent_id: str, health_status: HealthStatus) -> bool:
    ...
    def find_best_agent_for_task(
        ...
        for capability in required_capabilities:
            capable_agents = set(self.find_agents_by_capability(
                capability, 
        ...
        def agent_score(agent_id: str) -> float:
            load_ratio = self.agent_load[agent_id] / self.agents[agent_id]["max_concurrent_tasks"]
            ...
            score = (1 - load_ratio) * 0.4 + success_rate * 0.4 + (1 / (1 + response_time)) * 0.2
            return score
    ...
    async def get_agent_message(self, agent_id: str, timeout: Optional[float] = None) -> Optional[AgentMessage]:
        """
