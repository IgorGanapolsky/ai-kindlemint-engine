...
class CoverDesignAgent(BaseAgent):
    ...
    def _generate_front_cover_prompt(self, title: str, author: str, metadata: Dict) -> str:
...
NO text generation - only design elements and layout."""
    ...
    def _generate_back_cover_prompt(self, title: str, author: str, metadata: Dict) -> str:
