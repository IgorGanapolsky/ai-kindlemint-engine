...
class KDPPerformanceAgent(BaseAgent):
    ...
    async def _monitor_single_book(self, task: Task) -> TaskResult:
        ...
        try:
            ...
            return TaskResult(
                success=True, data={"book_id": book_id, "metrics": metrics}
            )
    ...
    async def _track_new_book(self, task: Task) -> TaskResult:
        ...
        return TaskResult(
            success=True, data={"message": f"Started tracking book {book_id}"}
        )
    ...
    async def _generate_performance_report(self, task: Task) -> TaskResult:
        ...
        try:
            ...
            return TaskResult(
                success=True, data={"report": report, "report_file": str(report_file)}
            )
    ...
    async def _update_book_metadata(self, task: Task) -> TaskResult:
        ...
        return TaskResult(
            success=True, data={"message": f"Updated metadata for book {book_id}"}
        )
