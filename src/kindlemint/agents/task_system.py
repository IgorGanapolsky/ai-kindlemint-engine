...
class Task:
    ...
    def can_retry(self) -> bool:
        ...
        return (
            ...
            and self.retry_count < self.constraints.max_retries
        )

    def add_dependency(
        self, task_id: str, dependency_type: str = "completion", optional: bool = False
    ) -> None:
        """Add a dependency to this task"""
        dependency = TaskDependency(
            task_id=task_id, dependency_type=dependency_type, optional=optional
        )
    ...
    def mark_failed(
        self, error_message: str, result: Optional[TaskResult] = None
    ) -> None:
        """Mark task as failed"""
        self.status = TaskStatus.FAILED
        self.end_time = datetime.now()
        ...
        return {
            ...
            "constraints": {
                ...
                "required_capabilities": [
                    cap.value for cap in (self.constraints.required_capabilities or [])
                ],
