...
class ContentAtomizer:
    ...
    def __init__(self):
        self.extraction_patterns = {
            ...
            ContentType.FRAMEWORK: [r'(?:The|This)\s+(\w+\s+(?:Framework|Model|System))'],
                ...
                for pattern in patterns:
                    ...
                    for match in matches:
                        ...
                        if len(text.split()) >= 5:  # Minimum 5 words
                            atomic_pieces.append(AtomicContent(
                                ...
                                engagement_score=self._calculate_engagement_score(text, content_type)
                            ))
    ...
    def _calculate_engagement_score(self, text: str, content_type: ContentType) -> float:
...
class PlatformOptimizer:
    ...
    def optimize(self, atomic_content: AtomicContent) -> OptimizedPost:
        ...
        # Optimize hashtags
        optimized_hashtags = atomic_content.hashtags[:self.optimization_rules["hashtag_limit"]]
...
class SocialMediaMarketing:
    ...
    def process_book(self, book_content: Dict[str, str], 
        ...
        return {
            ...
            "estimated_total_reach": sum(post.estimated_reach for post in self.optimized_posts),
...
def demo_social_media_marketing():
    ...
    marketing_system = SocialMediaMarketing(
        author_name="John Expert",
        expertise_area="Business Growth"
    )
    
    # Process the book
    target_platforms = [PlatformType.LINKEDIN, PlatformType.TWITTER, PlatformType.INSTAGRAM]
    ...
    for date in list(calendar.keys())[:3]:
        ...
        for post in calendar[date][:2]:  # Show 2 posts per day
            ...
            print(f"    Time: {post['scheduled_time']}, Reach: {post['estimated_reach']}")
