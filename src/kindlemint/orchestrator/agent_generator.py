...
class AgentGenerator:
    ...
    async def generate(self, agent_type: str, capabilities: List[str], 
                      framework: str = "langchain", output_path: str = None,
                      specialized: bool = False, **kwargs) -> Dict:
        """
        Generate a complete AI agent with specified capabilities
        """
        self.logger.info(f"Generating {agent_type} agent with capabilities: {capabilities}")
    ...
    def _generate_agent_code(self, agent_type: str, capabilities: List[str],
                           framework: str, specialized: bool, **kwargs) -> str:
    ...
    def _generate_agent_docs(self, agent_type: str, capabilities: List[str], **kwargs) -> str:
