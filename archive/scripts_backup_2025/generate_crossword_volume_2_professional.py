...
class ProfessionalCrosswordGenerator:
    def __init__(self):
        ...
        self.themes = [
            # Easy (1-17)
            "Kitchen Tools", "Ocean Life", "Classic Movies", "World Capitals", 
            "Famous Authors", "Musical Instruments", "Garden Flowers", "Space Exploration",
            "Ancient History", "Modern Art", "Weather Patterns", "Sports Equipment",
            "Holiday Traditions", "Science Terms", "Food & Cooking", "Transportation", "Animals",
            
            # Medium (18-33)
            "Geography", "Literature", "Mathematics", "Colors & Shapes", "Household Items",
            "Nature", "Technology", "Fashion", "Architecture", "Mythology", "Chemistry",
            "Astronomy", "Medicine", "Music Theory", "Philosophy", "Economics",
            
            # Hard (34-50)
            "Languages", "Archaeology", "Biology", "Physics", "Psychology", "Sociology",
            "Anthropology", "Geology", "Meteorology", "Ecology", "Zoology", "Botany",
            "Etymology", "Cryptography", "Quantum Physics", "Renaissance Art", "World Religions"
        ]
        
        # Common words for crosswords
        self.word_lists = {
            "easy": ["CAT", "DOG", "SUN", "MOON", "STAR", "TREE", "BOOK", "DOOR", "TIME", "LOVE",
                     "BIRD", "FISH", "HOME", "ROAD", "BLUE", "GREEN", "HAPPY", "SMILE", "WATER", "FIRE"],
            "medium": ["OCEAN", "MOUNTAIN", "GARDEN", "WINDOW", "PICTURE", "MEMORY", "JOURNEY", 
                       "FRIEND", "FAMILY", "HOLIDAY", "WEATHER", "SCIENCE", "HISTORY", "FUTURE",
                       "CASTLE", "BRIDGE", "PLANET", "DESERT", "FOREST", "VALLEY"],
            "hard": ["PHILOSOPHY", "ARCHAEOLOGY", "QUANTUM", "SYMPHONY", "METAPHOR", "ALGORITHM",
                     "RENAISSANCE", "MYTHOLOGY", "PSYCHOLOGY", "ATMOSPHERE", "CIVILIZATION",
                     "DEMOCRACY", "EVOLUTION", "GENETICS", "UNIVERSE", "PARADOX", "ENIGMA",
                     "LABYRINTH", "SERENDIPITY", "EPIPHANY"]
        }
    ...
    def create_crossword_grid(self):
        ...
        black_squares = [
            (0, 4), (0, 10), (1, 4), (1, 10), (2, 4), (2, 10),
            (4, 0), (4, 1), (4, 2), (4, 6), (4, 8), (4, 12), (4, 13), (4, 14),
            (6, 4), (6, 10), (8, 4), (8, 10),
            (10, 0), (10, 1), (10, 2), (10, 6), (10, 8), (10, 12), (10, 13), (10, 14),
            (12, 4), (12, 10), (13, 4), (13, 10), (14, 4), (14, 10)
        ]
    ...
    def create_pdf(self):
        ...
        c.drawCentredString(PAGE_WIDTH/2, PAGE_HEIGHT - 5.2*inch, "50 Medium Crossword Puzzles")
        c.drawCentredString(PAGE_WIDTH/2, PAGE_HEIGHT - 5.6*inch, "for Seniors")
        
        c.setFont("Helvetica", 12)
        c.drawCentredString(PAGE_WIDTH/2, PAGE_HEIGHT - 7*inch, "Crossword Masters Publishing")
        ...
        c.drawCentredString(PAGE_WIDTH/2, PAGE_HEIGHT - TOP_MARGIN - 0.5*inch, "How to Solve")
        ...
        for i in range(50):
            ...
            print(f"  📝 Generating Puzzle {puzzle_num}: {theme} ({difficulty.upper()})")
            ...
            c.setFont("Helvetica", 12)
            c.drawCentredString(PAGE_WIDTH/2, PAGE_HEIGHT - TOP_MARGIN - 0.7*inch, theme)
            c.setFont("Helvetica-Oblique", 10)
            c.drawCentredString(PAGE_WIDTH/2, PAGE_HEIGHT - TOP_MARGIN - 0.95*inch, f"Difficulty: {difficulty.capitalize()}")
        ...
        for i in range(3):  # Just first 3 for demo
            ...
            c.drawCentredString(PAGE_WIDTH/2, PAGE_HEIGHT - TOP_MARGIN - 0.5*inch, f"Puzzle {puzzle['id']} - {puzzle['theme']}")
        ...
        with open(self.paperback_dir / "puzzles_data.json", 'w') as f:
            json.dump([{
                ...
                "clue_count": len(p["clues"]["across"]) + len(p["clues"]["down"])
            } for p in puzzles_data], f, indent=2)
