...
class ValidatedCrosswordGenerator:
    def __init__(self):
        ...
        self.themed_words = {
            "animals": {
                3: ["CAT", "DOG", "PIG", "COW", "BAT", "BEE", "ANT", "FOX", "OWL", "ELK"],
                4: ["BEAR", "LION", "BIRD", "FISH", "DEER", "GOAT", "DUCK", "FROG", "WOLF", "LAMB"],
                5: ["HORSE", "TIGER", "EAGLE", "SNAKE", "MOUSE", "SHEEP", "WHALE", "SHARK", "ZEBRA", "MOOSE"],
                6: ["RABBIT", "MONKEY", "DONKEY", "TURTLE", "PARROT", "FALCON", "JAGUAR", "BEAVER", "WALRUS", "LIZARD"],
                7: ["GIRAFFE", "DOLPHIN", "PENGUIN", "BUFFALO", "OCTOPUS", "CHEETAH", "RACCOON", "PANTHER", "GAZELLE", "HAMSTER"]
            },
            "food": {
                3: ["PIE", "TEA", "HAM", "JAM", "EGG", "NUT", "ICE", "OIL", "RYE", "SOY"],
                4: ["CAKE", "MEAT", "RICE", "CORN", "BEAN", "MILK", "SALT", "SOUP", "TUNA", "LIME"],
                5: ["BREAD", "APPLE", "PASTA", "SALAD", "BACON", "HONEY", "JUICE", "CREAM", "ONION", "GRAPE"],
                6: ["BUTTER", "CHEESE", "POTATO", "TOMATO", "BANANA", "ORANGE", "CARROT", "PEPPER", "GARLIC", "CEREAL"],
                7: ["CHICKEN", "LETTUCE", "SPINACH", "AVOCADO", "COCONUT", "PANCAKE", "POPCORN", "NOODLES", "MUSTARD", "KETCHUP"]
            },
            "common": {
                3: ["THE", "AND", "FOR", "ARE", "BUT", "NOT", "YOU", "ALL", "CAN", "HER"],
                4: ["THAT", "WITH", "HAVE", "THIS", "WILL", "YOUR", "FROM", "THEY", "KNOW", "WANT"],
                5: ["WHICH", "THEIR", "WOULD", "THERE", "COULD", "BEING", "FIRST", "AFTER", "THESE", "OTHER"],
                6: ["BEFORE", "SHOULD", "PEOPLE", "THROUGH", "AROUND", "ANOTHER", "BETWEEN", "BECAUSE", "WITHOUT", "NOTHING"],
                7: ["HOWEVER", "ALREADY", "SEVERAL", "TOGETHER", "HIMSELF", "HERSELF", "SOMEONE", "EVERYONE", "ANYTHING", "SOMETHING"]
            }
        }
    ...
    def create_symmetric_pattern(self, puzzle_num: int) -> List[List[str]]:
        ...
        if puzzle_num % 3 == 0:
            ...
            # Diamond pattern
            positions = [(2,2), (2,12), (12,2), (12,12), (7,7),
                        (4,7), (10,7), (7,4), (7,10)]
            for r, c in positions:
                black_squares.append((r, c))
        else:
            # Scattered pattern
            positions = [(1,4), (1,10), (3,7), (5,2), (5,12),
                        (7,5), (7,9), (9,2), (9,12), (11,7), (13,4), (13,10)]
            for r, c in positions:
                black_squares.append((r, c))
    ...
    def fill_grid_validated(self, grid: List[List[str]], h_slots: List[Dict], 
                           v_slots: List[Dict], puzzle_num: int) -> Tuple[List[List[str]], List[Dict]]:
    ...
    def create_complete_book(self):
        ...
        for format_name, output_dir in [("paperback", self.paperback_dir), 
            ...
            for puzzle_num in range(1, 51):
                ...
                solution, placed_words = self.fill_grid_validated(grid, h_slots, v_slots, puzzle_num)
                ...
                empty_grid = [[solution[r][c] if solution[r][c] == '#' else '.' 
            ...
            for puzzle in all_puzzles:
                ...
                self.draw_solution_grid(c, grid_x, grid_y, puzzle['grid'], puzzle['solution'], cell_size)
