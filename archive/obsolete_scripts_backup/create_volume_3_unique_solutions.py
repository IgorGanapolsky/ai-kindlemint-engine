    ...
    def create_complete_book(self):
        ...
        for output_dir in [self.paperback_dir, self.hardcover_dir]:
            ...
            for puzzle_idx, puzzle in enumerate(all_puzzles):
                ...
                for i, (across, down) in enumerate(
                    zip(across_words[:10], down_words[:10])
                ):
                    if i < len(across_words):
                        ...
                        if word_info:
                            ...
                            c.drawString(
                                GUTTER + 0.5 * inch,
                                y_pos,
                                f"{clue_num}. {across} - {word_info['clue'][:30]}",
                            )
                    ...
                    if i < len(down_words):
                        ...
                        if word_info:
                            ...
                            c.drawString(
                                PAGE_WIDTH / 2 + 0.1 * inch,
                                y_pos,
                                f"{clue_num}. {down} - {word_info['clue'][:30]}",
                            )
            ...
            print(f"✅ Created Volume 3 with UNIQUE solutions: {pdf_path}")
...
def main():
    ...
    print("\n✅ Volume 3 regenerated with unique solutions for each puzzle!")
