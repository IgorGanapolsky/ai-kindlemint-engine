...
class ProperCrosswordGenerator:
    def __init__(self):
        ...
        self.words_by_length = {
            3: ["THE", "AND", "FOR", "ARE", "BUT", "NOT", "YOU", "ALL", "CAN", "HER", "WAS", "ONE", "OUR", "OUT", "DAY", "RUN", "CAT", "DOG", "SUN", "MAN", "BOY", "FUN", "SIT", "EAT", "RED", "BIG", "HOT", "NEW", "OLD", "GET", "PUT", "SEE", "TOP", "TRY", "TWO", "USE", "WAY", "WIN", "YES", "YET", "ARM", "BAD", "BAG", "BED", "BOX", "BUS", "CUP", "CUT", "DID", "EAR", "EGG", "END", "EYE", "FEW", "FIT", "FLY", "GOT", "GUN", "HAD", "HAT", "HIT", "JOB", "LAW", "LAY", "LEG", "LET", "LIE", "LOT", "LOW", "MAY", "MEN", "MOM", "NOR", "NOW", "OWN", "PAY", "PER", "RAN", "SAW", "SAY", "SET", "SHE", "SIX", "SON", "TEN", "TOO", "WAR", "WHO", "WHY", "WON"],
            
            4: ["THAT", "WITH", "HAVE", "THIS", "WILL", "YOUR", "FROM", "THEY", "KNOW", "WANT", "BEEN", "GOOD", "MUCH", "SOME", "TIME", "VERY", "WHEN", "COME", "HERE", "JUST", "LIKE", "LONG", "MAKE", "MANY", "OVER", "SUCH", "TAKE", "THAN", "THEM", "WELL", "ONLY", "YEAR", "WORK", "BACK", "CALL", "CAME", "EACH", "EVEN", "FIND", "GIVE", "HAND", "HIGH", "KEEP", "LAST", "LEFT", "LIFE", "LIVE", "LOOK", "MADE", "MOST", "MOVE", "MUST", "NAME", "NEED", "NEXT", "OPEN", "PART", "PLAY", "SAID", "SAME", "SEEM", "SHOW", "SIDE", "TELL", "TURN", "USED", "WANT", "WAYS", "WEEK", "WENT", "WERE", "WHAT", "WORD", "WORK", "YEAR", "ABLE", "ALSO", "BASE", "BEST", "BODY", "BOOK", "BOTH", "CARE", "CASE", "CITY", "DAYS", "DOOR", "DOWN", "FACE", "FACT", "FELT", "FIVE", "FOOD", "FOUR", "FREE", "FULL", "GAVE", "GIRL", "GOES", "GONE", "HALF", "HARD", "HEAD", "HELP", "HERE", "HOME", "HOPE", "HOUR", "IDEA", "KEEP", "KIND", "LAND", "LATE", "LESS", "LINE", "LOST", "LOVE", "MAIN", "MIND", "MISS", "ONCE", "PAGE", "PAST", "PLAN", "REAL", "REST", "ROAD", "ROOM", "SOON", "SURE", "TALK", "TOLD", "TOOK", "TOWN", "TREE", "TRUE", "UPON", "WALK", "WALL", "WARM", "WAVE", "WIFE", "WIND", "WISH", "WOOD", "WORD", "WORK"],
            
            5: ["WHICH", "THEIR", "WOULD", "THERE", "COULD", "BEING", "FIRST", "AFTER", "THESE", "OTHER", "WORDS", "WORLD", "WHERE", "STILL", "THREE", "NEVER", "UNDER", "WHILE", "ABOUT", "AGAIN", "BEFORE", "FOUND", "GOING", "GREAT", "HOUSE", "LARGE", "PLACE", "RIGHT", "SMALL", "SOUND", "STILL", "THINGS", "THINK", "THOSE", "WATER", "YEARS", "YOUNG", "ACROSS", "ALONG", "AMONG", "BEGAN", "BLACK", "BRING", "BUILD", "CARRY", "CLEAN", "CLOSE", "COMES", "COVER", "EARLY", "EVERY", "FIELD", "FINAL", "GIVEN", "GREEN", "HAPPY", "HEARD", "HEART", "HEAVY", "HORSE", "HOURS", "HUMAN", "LEARN", "LEAVE", "LIGHT", "MONEY", "MUSIC", "NIGHT", "NORTH", "OFTEN", "ORDER", "PAPER", "PARTY", "PEACE", "PIECE", "POINT", "POWER", "QUICK", "REACH", "RIVER", "ROUND", "SERVE", "SHORT", "SHOWN", "SINCE", "SLEEP", "SOUTH", "SPACE", "SPEAK", "SPEED", "SPEND", "STAND", "START", "STATE", "STORY", "TABLE", "TAKEN", "THIRD", "TODAY", "TOTAL", "TOUCH", "TRADE", "TRIED", "TRULY", "UNTIL", "VOICE", "WATCH", "WATER", "WAVES", "WHOLE", "WOMAN", "WOMEN", "WRITE", "WROTE"],
            
            6: ["BEFORE", "SHOULD", "PEOPLE", "THROUGH", "AROUND", "ANOTHER", "BETWEEN", "COUNTRY", "AGAINST", "BECAUSE", "WITHOUT", "THOUGHT", "GENERAL", "HOWEVER", "NOTHING", "PERHAPS", "PROBLEM", "SEVERAL", "TOGETHER", "ALREADY", "CERTAIN", "MORNING", "HIMSELF", "LOOKING", "SOMETHING", "BROUGHT", "GETTING", "ANYTHING", "BELIEVE", "COMPANY", "CONTROL", "DURING", "EITHER", "ENOUGH", "FATHER", "GROUND", "HAPPEN", "HAVING", "ITSELF", "LETTER", "LITTLE", "LIVING", "MAKING", "MATTER", "MEMBER", "MINUTE", "MOMENT", "MOTHER", "MYSELF", "NATURE", "OFFICE", "RATHER", "REASON", "RESULT", "SECOND", "SEEMED", "SIMPLE", "SOCIAL", "STREET", "SYSTEM", "TAKING", "THOUGH", "TURNED", "WITHIN", "ACROSS", "ALMOST", "ALWAYS", "AMOUNT", "ANIMAL", "ANSWER", "ANYONE", "APPEAR", "BECOME", "BEHIND", "BETTER", "CALLED", "CANNOT", "CENTER", "CHANGE", "CHURCH", "COMING", "COMMON", "COUPLE", "COURSE", "DECIDE", "DESIGN", "DIRECT", "DOCTOR", "EFFECT", "EFFORT", "EXAMPLE", "FAMILY", "FIGURE", "FOLLOW", "FRIEND", "FUTURE", "GARDEN", "HAPPEN", "HEALTH", "HISTORY", "INTEREST", "ISLAND", "LIKELY", "LISTEN", "MARKET", "MODERN", "NATION", "NUMBER", "PERIOD", "PERSON", "PICTURE", "PLAYED", "PLEASE", "POLICE", "POLICY", "PRESENT", "PUBLIC", "REPORT", "SCHOOL", "SEASON", "SEEMED", "SERIES", "SIMPLY", "SINGLE", "SPRING", "SQUARE", "STRONG", "SUBJECT", "SUMMER", "SUNDAY", "SUPPLY", "SYSTEM", "THEORY", "TRAVEL", "TRYING", "TURNED", "UNITED", "WALKED", "WANTED", "WINDOW", "WINTER", "WONDER", "WORKED", "WRITER", "YELLOW"],
            
            7: ["BECAUSE", "THROUGH", "BETWEEN", "ANOTHER", "AGAINST", "WITHOUT", "NOTHING", "PERHAPS", "PROBLEM", "SEVERAL", "TOGETHER", "ALREADY", "CERTAIN", "COUNTRY", "GENERAL", "HOWEVER", "LOOKING", "MORNING", "HIMSELF", "BELIEVE", "BROUGHT", "COMPANY", "CONTROL", "GETTING", "ANYTHING", "EXAMPLE", "FOLLOWING", "QUESTION", "INTEREST", "BUSINESS", "PROGRAM", "POSSIBLE", "IMPORTANT", "REMEMBER", "CHILDREN", "STUDENTS", "AMERICAN", "NATIONAL", "BUILDING", "SPECIAL", "ACTUALLY", "AVAILABLE", "EVIDENCE", "FUNCTION", "LANGUAGE", "PERSONAL", "POSITION", "PROBABLY", "RESEARCH", "SERVICES", "SOMETHING", "THOUGHT", "WHETHER", "ADDITION", "ALTHOUGH", "APPROACH", "ATTENTION", "BEHAVIOR", "COMMUNITY", "COMPLETE", "COMPUTER", "CONSIDER", "CONTINUE", "DECISION", "DESCRIBE", "DEVELOP", "DIFFERENT", "DISCOVER", "ECONOMIC", "EDUCATION", "ESTABLISH", "EVERYONE", "EXERCISE", "EXPERIENCE", "FINANCIAL", "FOLLOWING", "GOVERNMENT", "HAPPENED", "HOSPITAL", "INCREASE", "INDIVIDUAL", "INDUSTRY", "INFLUENCE", "INFORMATION", "KNOWLEDGE", "LEARNING", "MATERIAL", "MEDICINE", "MILITARY", "MOVEMENT", "NECESSARY", "OPPORTUNITY", "ORIGINAL", "PARTICULAR", "PERFORMANCE", "PHYSICAL", "POLITICAL", "POPULATION", "PRACTICE", "PRESSURE", "PROBABLY", "PRODUCE", "PROPERTY", "PROTECT", "PROVIDE", "PURPOSE", "QUALITY", "QUESTION", "RECENTLY", "RECOGNIZE", "RELATIONSHIP", "RELIGION", "REMEMBER", "REPRESENT", "RESOURCE", "RESPONSE", "SECURITY", "SENTENCE", "SITUATION", "SOCIETY", "SPECIFIC", "STANDARD", "STATEMENT", "STRUCTURE", "STUDENT", "SUCCESS", "SUPPORT", "SURFACE", "TECHNOLOGY", "THOUSAND", "THROUGHOUT", "TOMORROW", "TRAINING", "TREATMENT", "UNDERSTAND", "UNIVERSITY", "VARIOUS", "WHATEVER", "YOURSELF"]
        }
        
        # Clue templates
        self.clue_templates = {
            # Common 3-letter words
            "THE": ["Definite article", "Most common English word", "___ end (conclusion)"],
                    ...
                    for word in candidates:
                        ...
                        for i, letter in enumerate(word):
                            if col + i >= GRID_SIZE:
                                fits = False
                                break
                            if solution[row][col + i] != '' and solution[row][col + i] != letter:
                                fits = False
                                break
    ...
    def create_complete_book(self):
        ...
        for format_name, output_dir in [("paperback", self.paperback_dir), 
            ...
            for puzzle_num in range(1, 51):
                ...
                # Fill with words
                solution, placed_words = self.fill_grid_with_words(grid, word_slots, puzzle_num)
                ...
                for num, word_info in down_numbered:
                    c.drawString(PAGE_WIDTH/2 + 0.1*inch, y_pos, f"{num}. {word_info['clue']}")
                    y_pos -= 0.25*inch
                    if y_pos < BOTTOM_MARGIN + 1*inch:
                        break
